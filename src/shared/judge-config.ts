...
export const JUDGE_MODEL_GROUPS: JudgeModelGroup[] = [
  {
    ...
    options: [
      ...
      { value: 'eu.anthropic.claude-sonnet-4-20250514-v1:0', label: 'Claude Sonnet 4' },
      { value: 'eu.anthropic.claude-3-5-sonnet-20240620-v1:0', label: 'Claude 3.5 Sonnet' },
      { value: 'eu.anthropic.claude-3-5-haiku-20241022-v1:0', label: 'Claude 3.5 Haiku' },
      { value: 'eu.anthropic.claude-3-opus-20240229-v1:0', label: 'Claude 3 Opus' },
      { value: 'eu.anthropic.claude-3-haiku-20240307-v1:0', label: 'Claude 3 Haiku' },
    ],
  },
  {
    label: 'Amazon',
    options: [
      { value: 'eu.amazon.nova-premier-v1:0', label: 'Nova Premier' },
      { value: 'eu.amazon.nova-pro-v1:0', label: 'Nova Pro' },
      { value: 'eu.amazon.nova-lite-v1:0', label: 'Nova Lite' },
      { value: 'eu.amazon.nova-micro-v1:0', label: 'Nova Micro' },
      { value: 'eu.amazon.titan-text-express-v1', label: 'Titan Text Express' },
      { value: 'eu.amazon.titan-text-lite-v1', label: 'Titan Text Lite' },
    ],
  },
  {
    label: 'Meta',
    options: [
      { value: 'eu.meta.llama3-1-70b-instruct-v1:0', label: 'Llama 3.1 70B Instruct' },
      { value: 'eu.meta.llama3-1-8b-instruct-v1:0', label: 'Llama 3.1 8B Instruct' },
      { value: 'eu.meta.llama3-70b-instruct-v1:0', label: 'Llama 3 70B Instruct' },
      { value: 'eu.meta.llama3-8b-instruct-v1:0', label: 'Llama 3 8B Instruct' },
    ],
  },
  {
    label: 'Mistral',
    options: [
      { value: 'eu.mistral.mistral-large-2407-v1:0', label: 'Mistral Large' },
      { value: 'eu.mistral.mixtral-8x7b-instruct-v0:1', label: 'Mixtral 8x7B Instruct' },
      { value: 'eu.mistral.mistral-7b-instruct-v0:2', label: 'Mistral 7B Instruct' },
    ],
  },
  {
    label: 'Cohere',
    options: [
      { value: 'eu.cohere.command-r-plus-v1:0', label: 'Command R+' },
      { value: 'eu.cohere.command-r-v1:0', label: 'Command R' },
    ],
  },
  {
    label: 'AI21',
    options: [
      { value: 'eu.ai21.jamba-1-5-large-v1:0', label: 'Jamba 1.5 Large' },
      { value: 'eu.ai21.jamba-1-5-mini-v1:0', label: 'Jamba 1.5 Mini' },
    ],
  },
  {
    label: 'DeepSeek',
    options: [
      { value: 'eu.deepseek.r1-v1:0', label: 'DeepSeek R1' },
      { value: 'eu.deepseek.v3.2', label: 'DeepSeek V3.2' },
    ],
  },
];
