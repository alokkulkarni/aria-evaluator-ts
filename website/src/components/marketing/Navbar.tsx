...
export function Navbar() {
  ...
  // The translucent nav floats over the home page's dark hero. On other pages the
  // background is light, so a translucent dark bar reads as washed-out grey — use
  // the solid dark theme there (and once the home page is scrolled past the hero).
