...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/guides/conversational-ai-red-teaming`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${SITE_URL}/solutions/ai-red-teaming`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
